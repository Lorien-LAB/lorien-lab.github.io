...
4. A game permits replacing any three neighboring tiles by their complements. Find a conserved quantity or a constructive witness for transforming one specified binary row into another, and identify the smallest row length where your argument changes.
