...
export const leetcodeProblems: LeetCodeProblem[] = [
  ...
  problem({ number: 167, slug: 'two-sum-ii-input-array-is-sorted', title: 'Two Sum II - Input Array Is Sorted', difficulty: 'Medium', category: 'Two Pointers & Sliding Window', pattern: 'Sorted two pointers', quantApplication: 'Ordered threshold pairing', track: 'core', minimum25: false, week: 2 }),
